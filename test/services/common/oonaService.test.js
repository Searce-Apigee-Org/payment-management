...
import { applyOonaPricing } from '../../../src/services/common/oonaService.js';

const lab = Lab.script();
const { describe, it, beforeEach, afterEach } = lab;
export { lab };

describe('Service :: v1 :: applyOonaPricingService :: applyOonaPricing', () => {
  ...
  it('should throw MissingParameterValidateException if OONA_COMP_TRAVEL pricing missing', async () => {
    ...
    try {
      ...
      expect(err.message).to.include('Onna pricing for service id not found');
    }
  });
